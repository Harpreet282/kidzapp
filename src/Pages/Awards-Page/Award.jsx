...
<div className="row journey-slides">
  ...
  <div className="col">
    ...
    <div className='para'><p>Nomination Opens</p></div>
  </div>
  <div className="col">
  <img src={AWARDIMAGES.awardSecondImg} alt="" />
    <div className='para'><p>Nomination Closes</p></div>
  </div>
  <div className="col">
  <img src={AWARDIMAGES.awardThirdImg} alt="" />
   <div className='para'> <p>Voting Starts</p></div>
  </div>
  <div className="col">
  <img src={AWARDIMAGES.awardForthImg} alt="" />
   <div className='para'> <p>Voting Closes</p></div>
  </div>
  <div className="col">
