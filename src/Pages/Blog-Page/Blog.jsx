      ...
      <section className="topTabs container">
        ...
        <ul className="row">
          {blogTabData.map((tab, index) => {
            return (
              <div className="col-sm-3 col-md-3" key={tab.id}>
                {" "}
                <li
                  style={{
                    backgroundImage: `url(${
                      index === 0
                        ...
                        : index === 1
                        ? "https://beta.kidzapp.com/images/btn-02.png"
                        : index === 2
                        ? "https://beta.kidzapp.com/images/btn-03.png"
                        : index === 3
                ...
                >
                  <NavLink to="/" className="absolute-center">
                    {tab.internal_name}
                    <span text="">
                      <BiRightArrowAlt />
                    </span>
        ...
        <div className="blogListing">
          <h1>The KZ Blog</h1>
          <p>
            Your source for everything related to Arts & Crafts, Kids
            Activities, Parenting and Health & Nutrition.
          </p>
        </div>
      </section>
      <section className="displayCardsSection">
        <div className="products container">
          <div className="row absolute-center">
            {blogData.map((data) => {
              return (
                <div className="col-md-4 col-sm-6 py-4" key={data.id}>
                  <div className="card">
